...
if (!Array) {
  ...
  (_easycom_uni_easyinput2 + _easycom_uni_id_pages_agreements2 + _easycom_uni_id_pages_fab_login2)();
}
...
if (!Math) {
  (_easycom_uni_easyinput + _easycom_uni_id_pages_agreements + _easycom_uni_id_pages_fab_login)();
}
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    k: common_vendor.sr("agreements", "f1f87fcd-1"),
    l: common_vendor.p({
      scope: "register"
    }),
    m: common_vendor.o((...args) => $options.toSmsPage && $options.toSmsPage(...args))
  }, {
    n: common_vendor.sr("uniFabLogin", "f1f87fcd-2")
  });
}
